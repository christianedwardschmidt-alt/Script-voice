export default function SettingsPage() {
  return (
    <div style={{ padding: '28px 28px', background: 'var(--bg)', minHeight: '100%' }}>
      ...
      <p style={{ color: 'var(--text-2)', fontSize: 14, marginBottom: 24 }}>Configure your account preferences</p>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 14, maxWidth: 560 }}>
        ...
        <div className="card" style={{ padding: 18 }}>
          ...
          <div style={{ fontSize: 12, color: 'var(--text-2)', marginBottom: 12 }}>These actions are irreversible. Please proceed with caution.</div>
