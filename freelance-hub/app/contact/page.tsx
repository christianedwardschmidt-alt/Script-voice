    ...
    <div style={{ padding: '28px 28px', background: 'var(--bg)', minHeight: '100%' }}>
      ...
      <div className="card" style={{ padding: 28, maxWidth: 600 }}>
        ...
        <div style={{ marginTop: 18 }}>
          ...
          <textarea placeholder="Tell clients about yourself..." style={{ width: '100%', padding: '10px 12px', border: '1px solid rgba(0,0,0,0.06)', borderRadius: 10, fontSize: 14, color: '#1c1917', resize: 'none', outline: 'none', minHeight: 80, fontFamily: 'inherit', background: 'var(--card)' }} />
        </div>
