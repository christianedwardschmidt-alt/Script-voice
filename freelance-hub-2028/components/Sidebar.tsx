      ...
      >
        ...
        <div style={{ padding: '16px 20px', borderBottom: '1px solid #F3F4F6', flexShrink: 0 }}>
          <Link href="/dashboard" style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column', gap: 4 }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 500, color: '#9CA3AF', letterSpacing: '0.09em', lineHeight: 1.45 }}>Work for yourself.<span style={{ display: 'block' }}>Never by yourself.</span></span>
          </Link>
        </div>
