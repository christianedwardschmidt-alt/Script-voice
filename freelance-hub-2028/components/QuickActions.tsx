...
const ACTIONS = [
  ...
  { label: 'Add Client',   icon: Users,       href: '/clients',    shortcut: 'C', color: '#00b857' },
    ...
    <div ref={panelRef} style={{ position: 'relative' }}>
      <button
        ...
        style={{
          ...
          background: open
            ? 'linear-gradient(135deg, #007a3a, #00b857)'
            : 'linear-gradient(135deg, #007a3a, #00b857)',
          color: '#fff', fontSize: 12, fontWeight: 700,
          border: 'none', cursor: 'pointer',
          boxShadow: '0 1px 3px rgba(0,0,0,0.12), 0 4px 14px rgba(0,184,87,0.28)',
