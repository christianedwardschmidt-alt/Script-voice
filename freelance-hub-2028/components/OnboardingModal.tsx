...
export default function OnboardingModal() {
  ...
  useEffect(() => {
    const done = localStorage.getItem('gf_onboarded')
    if (!done) {
  ...
  function finish(href: string) {
    localStorage.setItem('gf_onboarded', '1')
    if (name) localStorage.setItem('gf_username', name)
    setShow(false)
    router.push(href)
  }
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ height: 3, background: '#f0f0f0' }}>
          <div style={{
            height: '100%', background: 'linear-gradient(90deg, #14532d, #16a34a)',
          ...
          {step === 0 && (
            <>
              ...
              <p style={{ fontSize: 13, color: 'rgba(15,17,23,0.55)', lineHeight: 1.6, marginBottom: 24 }}>
                Your craft, gilded. Let's personalize your workspace in 60 seconds.
              </p>
              ...
              <button
                ...
                style={{
                  ...
                  background: name.trim() ? 'linear-gradient(135deg, #14532d, #16a34a)' : 'rgba(0,0,0,0.08)',
