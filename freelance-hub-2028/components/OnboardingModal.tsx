...
const FIRST_ACTIONS = [
  ...
  { label: 'Add a client',            icon: Users,    href: '/clients',   color: '#00b857' },
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ height: 3, background: '#f0f0f0' }}>
          <div style={{
            height: '100%', background: 'linear-gradient(90deg, #007a3a, #00b857)',
          ...
          {step === 0 && (
            <>
              <div style={{
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                marginBottom: 20, boxShadow: '0 4px 16px rgba(0,184,87,0.3)',
              }}>
              ...
              <input
                ...
                onFocus={e => { e.target.style.borderColor = '#00b857'; e.target.style.background = '#fff' }}
              ...
              <button
                ...
                style={{
                  ...
                  background: name.trim() ? 'linear-gradient(135deg, #007a3a, #00b857)' : 'rgba(0,0,0,0.08)',
                  ...
                  boxShadow: name.trim() ? '0 4px 14px rgba(0,184,87,0.28)' : 'none',
                }}
              >
                ...
                {SPECIALTIES.map(s => (
                  <button
                    ...
                    style={{
                      ...
                      border: specialty === s.label ? '2px solid #00b857' : '1.5px solid rgba(0,0,0,0.1)',
                      background: specialty === s.label ? 'rgba(0,184,87,0.06)' : '#fafafa',
