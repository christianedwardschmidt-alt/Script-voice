...
import { Star, Users2, ArrowRight } from 'lucide-react'
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ maxWidth: 560, width: '100%', background: '#fff', borderRadius: 20, boxShadow: '0 8px 32px rgba(0,0,0,0.06)', border: '1px solid #F3F4F6', padding: 40, boxSizing: 'border-box' }}>
          <span style={{ display: 'inline-block', fontSize: 12, fontWeight: 600, padding: '3px 11px', borderRadius: 20, background: `${color}14`, color, fontFamily: 'var(--font-inter, sans-serif)', marginBottom: 16 }}>
            {agent.category}
          </span>
