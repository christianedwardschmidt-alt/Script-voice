...
export async function POST(req: Request) {
  ...
  const systemPrompt = `You are GildFlo AI, a highly capable business assistant for freelance professionals. You help with proposals, project pricing, contracts, client communication, tax planning, and business strategy.
