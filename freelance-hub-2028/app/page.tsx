...
/* Founding banner */
.lp-top-banner {
  background: linear-gradient(90deg, #92400E 0%, #CA8A04 50%, #92400E 100%);
  height: 44px; display: flex; align-items: center; justify-content: center;
  font-size: 13px; color: #fff; font-weight: 500; position: relative; gap: 6px;
  font-family: var(--font-inter);
}
.lp-top-banner a { color: #FEF3C7; font-weight: 700; text-decoration: underline; text-underline-offset: 2px; }
.lp-banner-close {
  position: absolute; right: 16px; background: none; border: none;
  color: rgba(255,255,255,0.6); cursor: pointer; font-size: 18px;
  line-height: 1; padding: 0 4px; font-family: inherit;
}
.lp-banner-close:hover { color: rgba(255,255,255,0.9); }

/* Nav */
.lp-nav {
  position: sticky; top: 0; left: 0; right: 0; z-index: 100;
  background: rgba(10,26,15,0.95); backdrop-filter: blur(20px) saturate(180%);
  border-bottom: 1px solid rgba(22,163,74,0.12);
}
.lp-nav-inner { display: flex; align-items: center; height: 72px; gap: 0; }
.lp-logo { display: inline-flex; align-items: center; flex-shrink: 0; text-decoration: none; }
.lp-logo-name {
  font-family: var(--font-syne), Syne, sans-serif;
  font-weight: 700; font-size: 20px; letter-spacing: -0.02em; line-height: 1;
}
.lp-nav-links { display: flex; gap: 32px; margin: 0 auto; }
.lp-nav-links a { color: rgba(255,255,255,0.6); font-size: 14px; font-weight: 500; transition: color 0.2s; }
...
.lp-btn-outline-nav {
  ...
  transition: all 0.18s; font-family: var(--font-inter);
}
.lp-btn-outline-nav:hover { border-color: rgba(255,255,255,0.4); color: #fff; background: rgba(255,255,255,0.06); }
.lp-btn-nav-primary {
  background: #16A34A; color: #fff; padding: 8px 18px; border-radius: 10px;
  font-size: 13px; font-weight: 600; transition: all 0.18s; font-family: var(--font-inter);
  box-shadow: 0 2px 8px rgba(22,163,74,0.3);
}
.lp-btn-nav-primary:hover { background: #15803D; transform: translateY(-1px); }
...
@media (max-width: 640px) {
  ...
  .lp-top-banner { font-size: 11px; }
  .lp-btn-nav-primary { display: none; }
        ...
        <nav className="lp-nav">
          <div className="lp-container lp-nav-inner">
            ...
            <div className="lp-nav-actions">
              ...
              <Link href="/signup" className="lp-btn-nav-primary">Start free →</Link>
            </div>
          </div>
        </nav>
