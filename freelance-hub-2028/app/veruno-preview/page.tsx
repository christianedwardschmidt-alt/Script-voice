...
export const metadata = {
  title: 'Veruno — The Operating System for Independent Professionals',
    ...
    <>
      ...
      <div className="lp" style={{ fontFamily: 'var(--font-inter), -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', background: '#fff' }}>
          ...
          <div className="lp-container">
            ...
            <div className="lp-social-proof">
              ...
              <span style={{ marginLeft: 10, color: 'rgba(255,255,255,0.42)', fontSize: 13 }}>
                Join 2,400+ independent professionals already on Veruno
              </span>
            </div>
          </div>
        </section>
        ...
        <section className="lp-pillars">
          <div className="lp-container">
            <div className="lp-section-eyebrow">Why Veruno</div>
            ...
            <div className="lp-pillars-grid">
              <div className="lp-pillar">
                ...
                <h3>Keep 97%</h3>
                <p>Stop giving 20% to platforms that don&apos;t work for you. Veruno charges a flat 3% — nothing else.</p>
              </div>
              <div className="lp-pillar">
                <div className="lp-pillar-icon-wrap">
        ...
        <footer className="lp-footer">
          <div className="lp-container">
            <div className="lp-footer-grid">
              <div>
                <div className="lp-footer-brand-name">
                  <span style={{ color: '#ffffff' }}>Veruno</span>
                </div>
            ...
            <div className="lp-footer-bottom">
              <p className="lp-footer-copy">© 2026 Veruno. All rights reserved.</p>
