...
function AIAssistantInner() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { id: 1, role: 'assistant', content: "Hi! I'm your CenterFlo AI assistant. I can answer questions AND take real actions in your workspace — try telling me to add a task, draft an invoice, schedule a meeting, search jobs, or add a client. What would you like to do?", timestamp: '12:00 PM' },
  ])
    ...
    <div style={{ display: 'flex', height: 'calc(100vh - 56px)', background: 'var(--bg)', overflow: 'hidden' }}>
      ...
      <div style={{ width: 240, background: 'var(--card)', borderRight: '1px solid rgba(0,0,0,0.06)', display: 'flex', flexDirection: 'column', padding: '20px 12px', flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 20, padding: '0 4px' }}>
          ...
          <div>
            <div style={{ fontSize: 13, fontWeight: 700, color: '#1c1917' }}>CenterFlo AI</div>
